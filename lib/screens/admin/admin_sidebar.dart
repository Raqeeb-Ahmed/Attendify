...
class AdminSidebar extends StatelessWidget {
    ...
    return Container(
      ...
      child: SafeArea(
        ...
        children: [
          ...
          _buildNavItem(1, Icons.location_on_rounded, 'Location Monitor', isAdmin: true),
          _buildNavItem(2, Icons.people_rounded, 'Employees', isAdmin: true),
          _buildNavItem(3, Icons.event_note_rounded, 'Attendance'),
          _buildNavItem(4, Icons.check_circle_outline, 'Leave Approvals', isAdmin: true),
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text('O.S Travel & ...', style: TextStyle(
                        fontSize: 12,
  ...
  Widget _buildNavItem(int index, IconData icon, String label, {bool isAdmin = false}) {
