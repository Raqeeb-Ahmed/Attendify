...
class _LeaveManagementScreenState extends State<LeaveManagementScreen> {
  ...
  IconData _getLeaveIcon(String id) {
    switch (id) {
      case 'annual':
  ...
  Color _getLeaveColor(String id) {
    switch (id) {
      case 'annual':
  ...
  Color _getLeaveBgColor(String id) {
    switch (id) {
      case 'annual':
                ...
                children: [
                  ...
                  GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final id = type['id'] as String;
                      final icon = _getLeaveIcon(id);
                      final color = _getLeaveColor(id);
  ...
  Widget _buildLeaveItem(Map<String, dynamic> leave) {
    ...
    final typeLabel = leave['leaveType']?.toString() ?? 'Leave';
    ...
    // Try to guess a clean type from the label
    String typeId = 'annual';
    final cleanLabel = typeLabel.toLowerCase();
    if (cleanLabel.contains('sick')) {
      typeId = 'sick';
    } else if (cleanLabel.contains('casual')) {
      typeId = 'casual';
    } else if (cleanLabel.contains('emergency')) {
      typeId = 'emergency';
    }

    final themeColor = _getLeaveColor(typeId);
    final themeBg = _getLeaveBgColor(typeId);
